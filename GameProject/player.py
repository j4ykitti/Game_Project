...
class Player(Entity):
    def __init__(self,pos,groups,obstacle_sprites,create_attack,destroy_attack,create_magic):
        ...
        self.image = pygame.image.load('../Character/Player/right/Player_run_right_1.png').convert_alpha()
        ...
        #stat
        self.stats = {'health': 100000,'energy': 60,'attack':10,'magic':4,'speed':6}
    ...
    def import_player_assests(self):
        character_path = '../Character/Player/'
